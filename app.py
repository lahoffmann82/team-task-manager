...
def main():
    ...
    # Ersteinrichtung: Wenn noch keine Mitarbeiter, direkt zur App
    if not members:
        st.title("📋 Team Task Manager — Ersteinrichtung")
        st.info("Willkommen! Bitte lege zuerst Mitarbeiter an.")
        st.session_state.user = {"email": "setup", "name": "Ersteinrichtung"}
